...
class Button {
    constructor(name, posX, posY, width, height, player) {
        //this.buttonResourcesWidth = buttonResourcesWidth;
        //this.buttonHeight = buttonResourcesHeight;
        this.button = game.add.button(posX, posY, 'button', player.increaseXP(), this, 3, 2, 1, 0);
...
class Character {
    constructor(name, playerNum) {
        ...
        this.buttonLevelUp = new Button("Level Up", this.buttonX, this.getButtonY(2) , buttonResourcesWidth, buttonResourcesHeight, this);
        this.buttonUseAbility = new Button("Use Ability", this.buttonX, this.getButtonY(3) , buttonResourcesWidth, buttonResourcesHeight, this);
        this.buttonTRaining = new Button("Trainging", this.buttonX, this.getButtonY(4) , buttonResourcesWidth, buttonResourcesHeight, this);


    }

    increaseXP() {
        this.cp += this.xpIncrease;
    }
